...
spanishWords = [ # including weird pronounciations
    ...
    ["si", "c", "sea"],
    ["libro", "libreal"],
    ["incorrect", "incorrect to", "incorrecto"],
    ["bonito"],
    ["cinco"],
    ["dia"],
    ["agua"],
...
class StartQuizIntentHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        print("SQ", ask_utils.is_intent_name("StartQuizIntent")(handler_input))
        print("sq intent:",handler_input)
...
class NewQuestionIntentHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        print("NQ", ask_utils.is_intent_name("NewQuestionIntent")(handler_input))
        print("nqintent: ", handler_input)
...
class CheckVocabIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = ""
        if str(vocab).lower() in spanishWords[gs.get_i() % len(englishWords)]: #"hola":
