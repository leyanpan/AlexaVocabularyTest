...
public class VocabTester {
    private HashMap<String, String> EnglishToSpanish = new HashMap<>();
    private HashMap<String, String> SpanishToEnglish = new HashMap<>();


    public VocabTester(ArrayList<String> English, ArrayList<String> Spanish) {
    ...
    public HashMap<String, String> getEnglishToSpanish() {
        return EnglishToSpanish;
    }

    public HashMap<String, String> getSpanishToEnglish() {
